...
int main(int argc, char *argv[]) {
    ...
    //build out file name
    char *l = argv[1]; //SIZE
    char *d = argv[2];//loopsize
    char *f = argv[3];//function Number
    ...
    void (*func)(const double *input1, const double *input2, double *output);
    switch (funcnum) {
                case 0: func=matmulijk; break;
                case 1: func=matmulSchleifenvertauschjki; break;
                case 2: func=matmulijkTiling; break;
                default: func=matmulijkWTemporary; break;
            }
